...
```{r}
#![image by Lum3n1](\images\math_001.jpg){ width=20%,height=5%}
```
## What is Correaltion?
...
Pearson Correlation measure only the linear relationship. If however your data contain curvilinear relationship, it will not detect it. 
